...
//
//--------------------------------------------------------------------------------------------------
pub var getTextureHandleARB: *const fn (texture: Uint) callconv(.C) Uint64 = undefined;
pub var getTextureSamplerHandleARB: *const fn (texture: Uint, sampler: Uint) callconv(.C) Uint64 = undefined;
pub var makeTextureHandleResidentARB: *const fn (handle: Uint64) callconv(.C) void = undefined;
pub var makeTextureHandleNonResidentARB: *const fn (handle: Uint64) callconv(.C) void = undefined;
pub var getImageHandleARB: *const fn (texture: Uint, level: Int, layered: Boolean, layer: Int) callconv(.C) Uint64 = undefined;
pub var makeImageHandleResidentARB: *const fn (handle: Uint64, access: Enum) callconv(.C) void = undefined;
pub var makeImageHandleNonResidentARB: *const fn (handle: Uint64) callconv(.C) void = undefined;
...
pub var isTextureHandleResidentARB: *const fn (handle: Uint64) callconv(.C) Boolean = undefined;
pub var isImageHandleResidentARB: *const fn (handle: Uint64) callconv(.C) Boolean = undefined;
pub var vertexAttribL1ui64ARB: *const fn (index: Uint, x: Uint64) callconv(.C) void = undefined;
pub var vertexAttribL1ui64vARB: *const fn (index: Uint, x: Uint64) callconv(.C) void = undefined;
