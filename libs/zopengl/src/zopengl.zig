...
pub fn loadExtension(loader: LoaderFn, extension: Extension) !void {
    ...
    switch (extension) {
        // ARB extensions ////////////////////////////////////////////////////////////////////////////////////
        .ARB_bindless_texture => {
            try load("glGetTextureHandleARB", .{&bindings.getTextureHandleARB});
            try load("glGetTextureSamplerHandleARB", .{&bindings.getTextureSamplerHandleARB});
            try load("glMakeTextureHandleResidentARB", .{&bindings.makeTextureHandleResidentARB});
            try load("glMakeTextureHandleNonResidentARB", .{&bindings.makeTextureHandleNonResidentARB});
            try load("glGetImageHandleARB", .{&bindings.getImageHandleARB});
            try load("glMakeImageHandleResidentARB", .{&bindings.makeImageHandleResidentARB});
            try load("glMakeImageHandleNonResidentARB", .{&bindings.makeImageHandleNonResidentARB});
            try load("glUniformHandleui64ARB", .{&bindings.uniformHandleui64ARB});
            try load("glUniformHandleui64vARB", .{&bindings.uniformHandleui64vARB});
            try load("glProgramUniformHandleui64ARB", .{&bindings.programUniformHandleui64ARB});
            try load("glProgramUniformHandleui64vARB", .{&bindings.programUniformHandleui64vARB});
            try load("glIsTextureHandleResidentARB", .{&bindings.isTextureHandleResidentARB});
            try load("glIsImageHandleResidentARB", .{&bindings.isImageHandleResidentARB});
            try load("glVertexAttribL1ui64ARB", .{&bindings.vertexAttribL1ui64ARB});
            try load("glVertexAttribL1ui64vARB", .{&bindings.vertexAttribL1ui64vARB});
            try load("glGetVertexAttribLui64vARB", .{&bindings.getVertexAttribLui64vARB});
        },
        // KHR extensions ////////////////////////////////////////////////////////////////////////////////////
        .KHR_debug => {
            try load("glDebugMessageControl", .{&bindings.debugMessageControl});
